...
API_KEY = "7960c8414d84b37e7451bee93fe67497"
...
for country in country_list:
    image = Image.open("/home/suman/suman/WeatherForecastPost/postdesign/post.png")
    draw = ImageDraw.Draw(image)

    font = ImageFont.truetype("/home/suman/suman/WeatherForecastPost/postdesign/Inter.ttf", size=50)
    content = "Latest Weather Forecast"
    color = 'rgb(255, 255, 255)'
    (x, y) = (55,50)
    draw.text((x, y), content, color, font=font)

    font = ImageFont.truetype("/home/suman/suman/WeatherForecastPost/postdesign/Inter.ttf", size=30)
    ...
    index = 0
    for city in country:
         url = "https://api.openweathermap.org/data/2.5/weather?q={0}&appid={1}&units=metric".format(city, API_KEY)
